...
const PLANET_ASSETS = [
  { texture: '/images/planet_rocky.png', color: '#ffaaaa', size: 0.8, radius: 5, inclination: 0.2, speed: 0.4 },
  { texture: '/images/planet_ice.png', color: '#aaffff', size: 1.0, radius: 7, inclination: -0.3, speed: 0.35 },
  { texture: '/images/planet_gas.png', color: '#ffeebb', size: 1.2, radius: 9, inclination: 0.5, speed: 0.3 },
  { texture: '/images/planet_void.png', color: '#ddccff', size: 0.7, radius: 11, inclination: -0.6, speed: 0.25 },
  { texture: '/images/planet_rocky.png', color: '#ccffcc', size: 0.9, radius: 13, inclination: 0.8, speed: 0.2 },
  { texture: '/images/planet_ice.png', color: '#ffccff', size: 1.1, radius: 15, inclination: -0.4, speed: 0.18 },
  { texture: '/images/planet_void.png', color: '#aaaaff', size: 0.7, radius: 17, inclination: 0.6, speed: 0.15 }
];
...
function Sun() {
  const texture = useLoader(THREE.TextureLoader, '/images/sun_texture.png');
